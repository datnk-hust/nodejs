    ...
    <div class="main-wrapper">
        ...
        <div class="header">
			<div class="header-left">
				<a href="#" class="logo">
					<img src="/assetss/img/logo.png" width="35" height="35" alt=""> <span>Quản lý thiết bị</span>
				</a>
			</div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{route('accessory.show')}}"><i class="fa fa-life-ring"></i> <span>Vật tư</span></a>
                        </li>
                        
                        <li>
                            <a href="{{route('show.provider')}}"><i class="fa fa-building"></i> <span>Nhà cung cấp</span></a>
                        </li>
                        @if( Auth::user()->rule == 1 )
                        <li>
