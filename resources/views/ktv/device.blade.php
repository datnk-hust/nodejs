  ...
  <div class="row">
    ...
    <div class="col-sm-4 col-5 text-right m-b-10">
              ...
              <div class="col-sm-4 col-4 text-right m-b-10">
                <a href="adduser.html" class="btn btn-rounded float-right" style="background-color: #009efb; color: white"><i class="fa fa-plus"></i> Thêm thiết bị mới</a>
              </div>
            </div>
            <div class="content">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-sm-3 col-3" style="text-align: center;">
                 <a href="#" class="btn btn-rounded " style="background-color: #009efb; color: white;"><i class="fa fa-search"> &nbsp;</i>Tìm kiếm</a>&nbsp;
