    ...
    */
    ...
    public function headings(): array
    {
    	return [
            ...
            [' ', ' ', ' ', ' ', ' ', ' ', ' ',' ',' ',' ', ' ', ' ', ' ', ' ', ' ', ' ',' ',' ',' '],
            ['STT', 'Mã thiết bị', 'Tên thiết bị','Loại thiết bị', 'Model', 'Serial', 'Hãng SX','Xuất xứ','Khoa phòng','Ngày bàn giao','Tình trạng sử dụng','Giá trị hiện tại(đv %)',  'Giá trị ban đầu (đv %)','Khấu hao hàng năm (đv %)','Năm SX','Giá nhập','Ngày nhập','Dự án thầu','Ghi chú']
        ];
    }
